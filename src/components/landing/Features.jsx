        ...
        <div className="grid lg:grid-cols-2 gap-16 items-center">
          ...
          <div>
            ...
            <h2 className="text-3xl md:text-4xl font-bold mb-4 text-dark">
              당신이 선택한{' '}
              <span className="text-primary">선호조건</span>을 반영합니다
            </h2>
            <p className="text-base leading-relaxed mb-8 text-muted">
              시간표 편성할 때 가장 많이 하는 고민들 위주로 실현 가능한 범위에서 조건들을 선별하였습니다.
            </p>

            {/* Speech bubble */}
            <div className="relative inline-block bg-secondary p-4 rounded-2xl rounded-bl-none">
              <p className="text-sm font-medium text-muted">
                "융합교양 채워야되서 하나 들어야하는데,,,"
              </p>
            </div>
          </div>
            ...
            {features.map((feature, index) => {
              ...
              return (
                ...
                >
                  ...
                  <h3 className="font-bold text-base mb-2 text-dark">
                    {feature.title}
                  </h3>
